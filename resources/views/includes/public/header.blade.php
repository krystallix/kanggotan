    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top navbar-light">
      <div class="container-fluid con-nav">
        <a class="navbar-brand" href="#">
          <img src="{{asset('img/logo.png')}}" alt="" width="20" height="20" class="d-inline-block align-text-top">
          Kanggotan.id
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          ...
          <form class="d-flex">
            ...
            <button id="logout-link" type="button" class="btn mx-2 btn-sm btn-outline-danger d-none">Log out</button>
          </form>
        </div>
      </div>
    </nav>
